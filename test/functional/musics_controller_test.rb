...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { artist: @music.artist, description: @music.description, filename: @music.filename, title: @music.title }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { artist: @music.artist, description: @music.description, filename: @music.filename, title: @music.title }
    assert_redirected_to music_path(assigns(:music))
  end
