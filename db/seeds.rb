...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   musics = Music.create([ {user_picture:'http://binaryapi.ap.org/b18aee87a63e4ad1954406ff9b08be2f/460x.jpg', user_name:'PSY', album_picture:'http://cfile9.uf.tistory.com/image/1866934D5003C7F71AB19A', album_title:'강남스타일', album_description:'오빤 강남스타일 낮에는 따사로운 인간적인 여자 커피 한잔의 여유를 아는 품격 있는 여자 밤이 오면 심장이 뜨거워지는 여자 그런 반전 있는 여자 나는 사나이 낮에는 너만큼 따사로운 그런 사나이 커피 식기도 전에 원샷 때리는 사나이 밤이 오면 심장이 터져버리는 사나이 그런 사나이', filename:'gangnam.mp3', ip:'127.0.0.1'},
		   {user_picture:'http://sure.joinsmsn.com/component/article_img/2011/09/2714263949321.jpg', user_name:'리쌍', album_picture:'http://wstarnews.hankyung.com/wstardata/images/photo/201108/b0ef8d2be70b4913bd261898dc1fcada.jpg', album_title:'독기', album_description:'난 독기를 품고 쿵치딱 흐르는 비트 위로 부딪친다 삶의 가르침과 고통을 쓰고 난 행복을 훔친다 Hook] 삶의 늪에서 삶의 늪에서 나는 더 큰 세상을 보네 삶의 끝에서 후회하지 않게 나는 미친듯이 달려 미친듯이 살어', filename:'독기.mp3', ip:'127.0.0.1'},
